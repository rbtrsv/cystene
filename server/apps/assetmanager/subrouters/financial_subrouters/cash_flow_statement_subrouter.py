...
async def update_cash_flow_statement(
    ...
    try:
        ...
        # Check entity access + role + subscription
        entity_access = await require_write_access(user.id, cash_flow_statement.entity_id, session, ['EDITOR', 'ADMIN', 'OWNER'])
...
async def delete_cash_flow_statement(
    ...
    try:
        ...
        # Check entity access + role + subscription
        entity_access = await require_write_access(user.id, cash_flow_statement.entity_id, session, ['ADMIN', 'OWNER'])
